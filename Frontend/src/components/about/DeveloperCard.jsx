...
const DeveloperCard = ({ developer, delay = 0 }) => (
  <BentoCard delay={delay} className="group hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50/50">
    <div className="flex items-start gap-4">
      ...
      <div className="flex-1 min-w-0 pt-1">
        <h3 className="text-lg font-bold text-gray-900 truncate">{developer.name || developer.login}</h3>
